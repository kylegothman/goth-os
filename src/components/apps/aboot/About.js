    ...
    return (
        <>
            ...
            <ul className=" mt-4 leading-tight tracking-tight text-sm md:text-base w-5/6 md:w-3/4 emoji-list">
                <li className=" list-pc">I'm a Full Stack Software Engineer who's been designing & building industry utilized applications since my second year of college. Since then, I've worked in startups, taken on freelance projects and worked private consulting. ( Hit me up <a className='text-underline' href='kyle.gothman@gmail.com'><u>kyle.gothman@gmail.com</u></a> )</li>
