...
const STATE_TITLE = 0,
      ...
      GLOW_FX = false, // this enables or disables the glow effect, if the game is running slow set this to false
      PARTICLES_FX = false, // this enables or disables the particles effect, if the game is running slow set this to false
...
const keys = new Array(256);
    ...
    function keyreset() {
      ...
      function renderWon(now) {
        ...
        context.font = `bold ${TITLE_SIZE}px VT323, sans-serif`;
        context.textAlign = "center";
        context.textBaseline = "middle";
        
        renderSinText(now, TEXT, TITLE_SIZE);
        
        context.font = `bold ${SUBTITLE_SIZE}px VT323, sans-serif`;
      ...
      function renderPoints() {
        ...
        context.font = `bold ${POINTS_SIZE}px VT323, sans-serif`;
        context.textBaseline = "top";
  ...
  return (
    <div className="w-full h-full overflow-x-visible flex justify-center items-center">
      <canvas ref={canvasRef} height='750' width='1000' />
      </div>
    );
};

export default DisPong;